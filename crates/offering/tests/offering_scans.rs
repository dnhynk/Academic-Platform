...
const DECLARATIONS: &[&str] = &[
    ...
    "src/forecast.rs [priv] fn decide( history: &CourseHistory, window: ObservationWindow, features: &FeatureVector, raw_units: u32, policy: ForecastPolicy, registry: &CalibrationRegistry, now: TimestampMillis, frozen_inputs_digest: ContentDigest, ) -> Result<ForecastVerdict, OfferingError>",
    ...
    "src/forecast.rs [pub] fn actor(&self) -> &academic_domain::Actor",
