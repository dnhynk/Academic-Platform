...
`S-20`. Eleven of the eighteen `OpenGate::identifier` arms in this workspace are
...
rather than repaired, because each is another task's contract surface. The row
carries the measurement and the closing cost.
